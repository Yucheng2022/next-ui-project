...
export function Footer() {
  ...
  return (
    <footer className="w-full border-t border-divider py-8 mt-10">
        ...
        <div className="mt-8 border-t border-divider pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-2">
              <span className="font-bold bg-gradient-to-r from-primary-500 to-secondary-500 bg-clip-text text-transparent">
                NextUI Project
              </span>
